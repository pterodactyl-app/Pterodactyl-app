...
class LoginReviveNodePage extends StatefulWidget {
  @override
  _LoginReviveNodePageState createState() => new _LoginReviveNodePageState();
}

bool checkValue = false;

class _LoginReviveNodePageState extends State<LoginReviveNodePage> {
  ...
  getCredential() async {
    ...
    setState(() {
      ...
      if (checkValue != null) {
        if (checkValue) {
          _apiController.text = sharedPreferences.getString("api_revicenode_Key");
        } else {
          _apiController.clear();
