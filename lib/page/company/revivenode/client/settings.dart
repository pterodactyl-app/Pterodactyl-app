...
class ReviveNodeSettingsList extends StatefulWidget {
  @override
  ReviveNodeSettingsListState createState() => new ReviveNodeSettingsListState();
}

class ReviveNodeSettingsListState extends State<ReviveNodeSettingsList> {
