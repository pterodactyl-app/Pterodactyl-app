...
class LoginPlanetNodePage extends StatefulWidget {
  @override
  _LoginPlanetNodePageState createState() => new _LoginPlanetNodePageState();
}

bool checkValue = false;

class _LoginPlanetNodePageState extends State<LoginPlanetNodePage> {
