...
class MyPlanetNodeHomePage extends StatefulWidget {
  ...
  @override
  _MyPlanetNodeHomePageState createState() => _MyPlanetNodeHomePageState();
}

class _MyPlanetNodeHomePageState extends State<MyPlanetNodeHomePage> {
  Map data;
          ...
          children: <Widget>[
            _buildTile(
              ...
              onTap: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => PlanetNodeServerListPage())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
              ...
              onTap: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => PlanetNodeSettingsList())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
