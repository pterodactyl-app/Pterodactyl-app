...
class AccurateNodeServerListPage extends StatefulWidget {
  ...
  @override
  _AccurateNodeServerListPageState createState() => _AccurateNodeServerListPageState();
}

class _AccurateNodeServerListPageState extends State<AccurateNodeServerListPage> {
