...
class MyAccurateNodeHomePage extends StatefulWidget {
  ...
  @override
  _MyAccurateNodeHomePageState createState() => _MyAccurateNodeHomePageState();
}

class _MyAccurateNodeHomePageState extends State<MyAccurateNodeHomePage> {
  Map data;
          ...
          children: <Widget>[
            _buildTile(
              ...
              onTap: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => AccurateNodeServerListPage())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
              ...
              onTap: () => Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => AccurateNodeSettingsList())),
            ),
            _buildTile(
              Padding(
                padding: const EdgeInsets.all(24.0),
