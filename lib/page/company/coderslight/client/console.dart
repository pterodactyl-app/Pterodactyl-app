...
class _SendPageState extends State<SendPage> {
  ...
  Future postSend() async {
    ...
    var url = 'https://panel.coderslight.com/api/client/servers/${widget.server.id}/command';
  ...
  getServerInfo() async {
    ...
    var url = 'https://panel.coderslight.com/api/app/user/console/${widget.server.id}';
