...
class MyMiniCenterHomePage extends StatefulWidget {
  MyMiniCenterHomePage({Key key}) : super(key: key);

  @override
  _MyMiniCenterHomePageState createState() => _MyMiniCenterHomePageState();
}

class _MyMiniCenterHomePageState extends State<MyMiniCenterHomePage> {
  Map data;
