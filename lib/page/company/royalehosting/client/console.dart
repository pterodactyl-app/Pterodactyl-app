...
class _SendPageState extends State<SendPage> {
  ...
  Future postSend() async {
    ...
    String _api =
        await SharedPreferencesHelper.getString("api_royalehosting_Key");
    var url =
        'https://pterodactyl.rhmc.nl/api/client/servers/${widget.server.id}/command';
  ...
  getServerInfo() async {
    ...
    var url =
        'https://pterodactyl.rhmc.nl/api/app/user/console/${widget.server.id}';
