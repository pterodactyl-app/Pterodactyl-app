...
class SettingsList extends StatefulWidget {
  ...
  @override
  SettingsListPageState createState() =>
      new SettingsListPageState(this.settings);
}
...
class ActionsRow extends StatelessWidget {
  ...
  final TextStyle actionsItemTextStyle = TextStyle(
      color:
          globals.useDarkTheme ? Colors.white : Colors.black.withOpacity(0.8),
      fontSize: 12);
}
...
// save new value
  ...
  Widget _buildSettingsItem(
      IconData icon, String iconBgColor, String title, String description,
      {Function onTap: null}) {
// ignore: avoid_init_to_null
    return Division(
  ...
  final StyleClass settingsItemIconStyle =
      StyleClass().margin(left: 15).padding(all: 12).borderRadius(all: 30);
