...
class _TextEditorPageState extends State<TextEditorPage> {
  ...
  textEditorListener(){
    setState(()=> _uncommitedChanges = textEditorController.text != _stableFile);
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {return _uncommitedChanges ? showDialog(
        context: context,
      ...
      child: Scaffold(
            ...
            _isUpdating ? IconButton(
              ...
              icon: Tooltip(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => _updateChanges(textEditorController.text),
                      ),
                    ),
          ],
        ),
        body: FutureBuilder(
          future: _stableFile == null
              ? rootBundle.loadString(widget.file.url).then((data) => _stableFile = data).then((data) => textEditorController.text = data) : null,
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            ...
            return Container(
              ...
              child: Container(
                ...
                child: Scrollbar( //TODO: see if directly adding scrollbar to textfield works.
        ...
        SnackBar(
          content: Row(
            children:[
              ...
              SizedBox(width: 10,),
              Text(e != null ? "File updated!" : "An error occured, please try again later."),
            ],
          ),
